...
bool HomeLayer::init()
{
    ...
    Label::createWithSystemFont(str, "Arial", 48);
    ...
    ImageView *moneyBg=ImageView::create();
    moneyBg->loadTexture("coin1.png");
    moneyBg->setPosition(ccp(winSize.width/2-60,winSize.height/2-moneyBg->getPosition().y+100));
    
    ul->addChild(moneyBg);
    
    ImageView *coinBg=ImageView::create();
    coinBg->loadTexture("money1.png");
    ...
    LanguageType language=Application::sharedApplication()->getCurrentLanguage();
    Button* textButton = Button::create();
    textButton->setTouchEnabled(true);
    textButton->loadTextures("zhuangbei1.png", "zhuangbei2.png", "zhuangbei2.png");
    textButton->setPosition(ccp(winSize.width/2-60,winSize.height/2-100));
    ...
    textButton1->setPosition(ccp(textButton->getPosition().x,winSize.height/2-200));
    ...
    textButton2->setPosition(ccp(textButton->getPosition().x+120,winSize.height/2-100));
    ...
    Button* textButton3 = Button::create();
    textButton3->setTouchEnabled(true);
    textButton3->loadTextures("levelup1.png", "levelup2.png", "");
    textButton3->setPosition(ccp(textButton->getPosition().x+120,winSize.height/2-200));
